...
menu_database = {
    "🍜 鍋燒意麵系列": [
        ...
        "人氣奶香牛奶", "經典辣味奶香(預設為中辣)", "必點重慶辣椒(預設為中辣)", 
        "泰式酸辣冬蔭功", "馬來西亞叻沙", "南洋檸檬香茅鍋"
    ],
    "🍞 厚奶酥厚片系列": [
        "復刻原味厚奶酥*蛋奶素", "可可布朗尼厚奶酥*蛋奶素", "宇治抹茶厚奶酥*蛋奶素", 
        "流沙花生厚奶酥*蛋奶素", "草莓厚奶酥*蛋奶素", "芋泥厚奶酥*蛋奶素", 
        "蒜香厚奶酥", "鹹蛋黃厚奶酥", "榛果厚奶酥*蛋奶素", "咖啡厚奶酥", 
    ...
    "🥟 私房點心系列": [
        "港式叉燒包(2入)兩份165", "香蒸流沙包(2入)兩份165", "蟹黃燒賣(3入)兩份165", 
        "鮮蝦燒賣(3入)兩份165", "糯米珍珠丸(3入)兩份165", "香酥腐衣蝦捲(2條)兩份165", 
        "酥炸鮮奶馬蹄條(3條)兩份165", "酥炸韭菜小春捲(2條)兩份165"
    ],
    "🍲 韓式豆腐煲系列": [
        "韓式海陸豆腐粉絲煲(預設為小辣)", "韓式味噌豆腐粉絲煲"
    ]
}
...
def check_dudoo_store():
    ...
    with sync_playwright() as p:
        ...
        # 抓取全網頁文字做大品項初步檢查
        all_page_text = page.locator("body").inner_text()
